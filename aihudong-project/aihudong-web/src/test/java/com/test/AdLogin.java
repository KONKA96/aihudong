...
public class AdLogin {
    public static void main(String[] args) {
        String userName = "root";//AD域认证，用户的登录UserName
        String password = "www.123.com";//AD域认证，用户的登录PassWord
        String host = "mgmt.51asj.com";//AD域IP，必须填写正确 172.31.13.226  mgmt.51asj.com
        String domain = "@xxx.xx";//域名后缀，例.@noker.cn.com
        String port = "22"; //端口，一般默认389

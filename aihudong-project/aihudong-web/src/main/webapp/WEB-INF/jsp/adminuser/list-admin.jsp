		                    	...
		                    	<div class="row">
		                    		<div class="col-sm-2">
		                    			<div class="dataTables_length">
		                    				<a href="/aihudong-web/admin/toUpdateAdmin" class="btn btn-primary ">新增用户</a>
		                    			</div>
		                    		</div>
		                    		<div class="col-sm-10">
	                            			...
	                            			<td>
			                                 ...
			                                 <td>
												...
												onclick="addBuilding(${admin.id});"><i
													style="margin-left: 5px;" class="fa fa-diamond"></i></a></c:if>
			                                 	<a href="/aihudong-web/admin/toUpdateAdmin?id=${admin.id }"><i style="margin-left:5px;" class="fa fa-edit"></i></a>
...
function addFaculty(id){
	...
	function(inputValue){   
		...
		if (inputValue === "") {     
			...
			//在这里触发ajax进行新增
			$.ajax({
				url:"/aihudong-web/faculty/updateFaculty",
...
function changeSubject(object){
	...
	function deleteAdmin(id){
		...
		if(f){
			$.ajax({
				url:"/aihudong-web/admin/deleteAdmin",
				data:"id="+id,
				type:"post",
				success:function(data){
					if(data=='success'){

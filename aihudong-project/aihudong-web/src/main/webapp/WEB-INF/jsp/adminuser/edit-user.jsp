                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" id="editForm">
                        	...
                        	<div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input id="username" name="username" value="${teacher.username }" type="text" class="form-control" placeholder="用户名">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">密码</label>
                                <div class="col-sm-10">
                                    <input id="password" name="password" value="${teacher.password }" type="text"  class="form-control" placeholder="密码">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">真实姓名</label>
                                <div class="col-sm-10">
                                    <input id="truename" name="truename" value="${teacher.truename }" type="text" class="form-control" placeholder="真实姓名">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="telephone" value="${teacher.telephone }" type="text" class="form-control" placeholder="联系方式">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="email" value="${teacher.email }" type="text" class="form-control" placeholder="电子邮箱">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control m-b" name="sex">
                                    		<option value="0" ${teacher.sex==0 ? 'selected' :'' }>男</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control m-b" onchange="changeSubject(this)">
	                                    ...
	                                    <c:forEach items="${facultyList }" var="faculty">
	                                    	<option value="${faculty.id}" ${teacher.subject.faculty.id==faculty.id ? 'selected' : '' }>${faculty.facultyName }</option>
	                                    </c:forEach>
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control m-b" id="subjectSelected" name="subjectId">
                                    	...
                                    	<c:forEach items="${facultyList }" var="faculty">
                                    		<c:if test="${teacher.subject.faculty.id==faculty.id}">
                                    			<c:forEach items="${faculty.subjectList }" var="subject">
                                    				<option value="${subject.id}" ${teacher.subject.id==subject.id ? 'selected' : '' }>${subject.subjectName }</option>
                                    			</c:forEach>
                                    		</c:if>
	                                    </c:forEach>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="job" value="${teacher.job }" type="text" class="form-control" placeholder="职务">
                                </div>
                            </div>
                            <div class="form-group">
...
<script type="text/javascript">
	...
	function updateInfo(){
		...
		$.ajax({
			url:"/aihudong-web/teacher/updateInfo",
			data:$("#editForm").serialize(),
			type:"post",
			success:function(data){
				if(data=='success'){
					alert("操作成功！");
					window.location="/aihudong-web/teacher/showAllTeacher";
				}else if(data=='same'){
					alert("用户名不能重复！");
				}else{
					alert("操作失败");

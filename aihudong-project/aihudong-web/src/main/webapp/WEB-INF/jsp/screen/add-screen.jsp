					...
					<div class="ibox-content">
						<form class="form-horizontal" id="editForm">
								...
								<div class="col-sm-10">
									<div class="input-group">
										<input id="buildingInput" type="text" 
											name="buildingList[0].buildingName" class="form-control" onkeyup="emptyBuilding()"
											aria-label="...">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select id="screenNumber" class="form-control m-b" name="number"
										onchange="produceUsnPwd(this)">
										<option value="">--请选择--</option>
...
<script type="text/javascript">
	...
	function produceUsnPwd(obj) {
		...
		$
				.ajax({
					url : "/aihudong-web/screen/selectScreenByRoom",
	...
	function changeZone(object) {
		...
		$.ajax({
			url : "/aihudong-web/screen/getZone",
	...
	function changeBuilding(object) {
		...
		$.ajax({
			url : "/aihudong-web/screen/getRoom",
	...
	function updateInfo() {
	   ...
	   /*  
	    ...
	    if($("#roomId").val() == null
		    ...
		    $.ajax({
				...
				success : function(data) {
					if (data.course_id!=null) {
						$.ajax({
							url : "/aihudong-web/screen/insertScreen?id="+data.course_id,
							data : $("#editFormScreen").serialize(),
							type : "post",
							success : function(data) {
								if (data == 'success') {
									alert("操作成功！");
									window.location = "/aihudong-web/screen/showAllScreen";
								} else if (data == "error") {
	    	...
	    	$.ajax({
				url : "/aihudong-web/screen/insertScreen",
				data : $("#editFormScreen").serialize(),
				type : "post",
				success : function(data) {
					if (data == 'success') {
			...
			$.ajax({
				...
				success : function(data) {
					if (data.room_id!=null) {
						$.ajax({
							url : "/aihudong-web/screen/insertScreen?id="+data.room_id,
							data : $("#editFormScreen").serialize(),
							type : "post",
							success : function(data) {
								if (data == 'success') {

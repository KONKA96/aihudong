					...
					<div class="ibox-content">
						<div class="dataTables_wrapper form-inline" role="grid">
							...
							<form method="post" id="searchForm"
								action="/aihudong-web/screen/showAllScreen">
								<div class="row">
									<c:if test="${admin.power!=1 }">
									<div class="col-sm-2">
										<div class="dataTables_length">
											<a href="/aihudong-web/screen/toUpdateScreen"
								...
								<form method="POST" enctype="multipart/form-data" id="form1"
									...
									<table>
										<tr>
											...
											<td><a href="/aihudong-web/screen/exportExcel" class="btn btn-success">Excel批量导出</a></td>
										</tr>
									</table>
								</form>
							</c:if>
								...
								<tbody>
									<c:forEach items="${screenList }" var="screen">
										<tr class="gradeA">
											...
											<c:if test="${admin.power==0 || admin.power==2}">
												<td><a
													href="/aihudong-web/screen/toUpdateScreen?id=${screen.id }"><i
													...
													href="/aihudong-web/screen/screenTransfer?id=${screen.id }"><i
							...
							<jsp:include page="../common/include_page.jsp">
								<jsp:param value="/aihudong-web/screen/showAllScreen"
									name="pageTitle" />
							</jsp:include>
							<!-- 分页结束 -->
						</div>
...
function checkData(){  
   ...
   return true;  
	...
	function deleteScreen(id){
		...
		if(f){
			$.ajax({
				url:"/aihudong-web/screen/deleteScreen",
				data:"id="+id,
				type:"post",
				success:function(data){
					if(data=='success'){

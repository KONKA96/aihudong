                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                    	<div  class="dataTables_wrapper form-inline" role="grid">
                    		<!-- 查询条件 -->
	                    	<form method="post" id="searchForm" action="/aihudong-web/student/showAllStudent">
		                    	<div class="row">
		                    		<div class="col-sm-2">
		                    			<div class="dataTables_length">
		                    				<a href="/aihudong-web/student/toUpdate" class="btn btn-primary ">新增学生</a>
		                    			</div>
		                    		</div>
		                    		<div class="col-sm-10">
                    		...
                    		<form method="POST"  enctype="multipart/form-data" id="form1" action="/aihudong-web/student/uploadExcel">  
						        <table>  
						        <tr>  
	                            ...
	                            <tbody>
	                            	<c:forEach items="${studentList }" var="student">
	                            		<tr class="gradeA">
			                                 ...
			                                 <td>
			                                 	<a href="/aihudong-web/student/toUpdate?id=${student.id }"><i style="margin-left:5px;" class="fa fa-edit"></i></a>
							...
							<jsp:include page="../common/include_page.jsp">
 								<jsp:param value="/aihudong-web/student/showAllStudent" name="pageTitle"/>
							</jsp:include>
							<!-- 分页结束 -->
                    </div>
                    </div>
...
function changeSubject(object){
	...
	function deleteStudent(id){
		...
		if(f){
			$.ajax({
				url:"/aihudong-web/student/deleteStudent",
				data:"id="+id,
				type:"post",
				success:function(data){
					if(data=='success'){
						alert("操作成功！");
						window.location="/aihudong-web/student/showAllStudent";
					}else{
						alert("操作失败");
					}
				}

    ...
    <div id="wrapper">
                    ...
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                <li><a class="J_menuItem" href="/aihudong-web/admin/toAdminInfo">个人资料</a>
                                </li>
                               <!--  <li><a class="J_menuItem" href="contacts.html">联系我们</a>
                                ...
                                <li class="divider"></li>
                                <li><a href="/aihudong-web/admin/adminLogout" onclick="return confirm('${admin.truename},你确定要退出了吗？')">安全退出</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <c:if test="${admin.power==0 }">
	                        <li>
	                                ...
	                                <ul class="nav nav-third-level">
	                                    	<li>
	                                    		<a href="/aihudong-web/teacher/showAllTeacher" class="J_menuItem">教师管理</a>
	                                    		<a href="/aihudong-web/student/showAllStudent" class="J_menuItem">学生管理</a>
	                                    	</li>
	                                </ul>
	                        </li>
			                <li>
				               <a class="J_menuItem" href="/aihudong-web/screen/showAllScreen">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row content-tabs">
                ...
                <a href="/aihudong-web/admin/adminLogout" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
            </div>
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="/aihudong-web/admin/toAdminIndex" frameborder="0" data-id="index_v1.html" seamless></iframe>
           		<%-- <c:if test="${admin.power==1 }">
                	<iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="/aihudong-web/yiji/toAdminIndex" frameborder="0" data-id="index_v1.html" seamless></iframe>
           		</c:if> --%>
            </div>
            <div class="footer">
